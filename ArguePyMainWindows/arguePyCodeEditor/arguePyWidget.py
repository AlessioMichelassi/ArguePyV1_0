...
from ArguePyMainWindows.arguePyCodeEditor.EditorCodeMain import codeEditor
from ArguePyMainWindows.arguePyCodeEditor.searchAndReplaceWidget import searchAndReplaceWidget
...
class ArguePyWidget(QWidget):
    ...
    def saveFile(self):
        """
        Questo metodo salva il codice nel file
        :return:
        """
